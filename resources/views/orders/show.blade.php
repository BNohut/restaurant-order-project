...
<div class="row">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        @elseif($order->status->name === 'out_for_delivery')
                            <div class="alert alert-info">
                                <p class="mb-2"><i class="bi bi-bicycle"></i> <strong>Your order is out for delivery</strong></p>
    ...
    <div class="col-lg-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2">
                    <span>Subtotal:</span>
                    <span>₺{{ number_format($order->total_amount - $order->delivery_fee - $order->tax_amount, 2) }}</span>
                </div>
        ...
        <!-- Track Order -->
        @if(!in_array($order->status->name, ['delivered', 'canceled']))
        <div class="card">
            <div class="card-header">
            ...
            <div class="card-body">
                <div class="track-order">
                    <div class="step {{ in_array($order->status->name, ['pending', 'confirmed', 'preparing', 'ready', 'out_for_delivery', 'delivered']) ? 'active' : '' }}">
                        <div class="step-icon"><i class="bi bi-clipboard-check"></i></div>
                        <div class="step-text">Order Placed</div>
                    </div>
                    <div class="step {{ in_array($order->status->name, ['confirmed', 'preparing', 'ready', 'out_for_delivery', 'delivered']) ? 'active' : '' }}">
                        <div class="step-icon"><i class="bi bi-check-circle"></i></div>
                        <div class="step-text">Confirmed</div>
                    </div>
                    <div class="step {{ in_array($order->status->name, ['preparing', 'ready', 'out_for_delivery', 'delivered']) ? 'active' : '' }}">
                        <div class="step-icon"><i class="bi bi-fire"></i></div>
                        <div class="step-text">Preparing</div>
                    </div>
                    <div class="step {{ in_array($order->status->name, ['ready', 'out_for_delivery', 'delivered']) ? 'active' : '' }}">
                        <div class="step-icon"><i class="bi bi-bag-check"></i></div>
                        <div class="step-text">Ready</div>
                    </div>
                    <div class="step {{ in_array($order->status->name, ['out_for_delivery', 'delivered']) ? 'active' : '' }}">
